                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Digestive_symptome digestive_symptome = Digestive_symptome(Nausees: Nausees_value.toString(),Vomissements: Vommissements_value.toString(),Diarrhees: Diarrhees_value.toString(),Constipation: Constipation_value.toString(),Mucite: Mucite_value.toString(),Douleurs_abdominales: Douleurs_value.toString(),Modification_gouts:Gouts_value.toString(),Toxicity_day:'${toxicity_day?.day.toString()} ${_getMonthDate(toxicity_day!.month).toString()} ${toxicity_day?.year.toString()}',Nausees_grade:nausees.Grade,Diarrhees_grade:diarrhees.Grade,Patient_Ip: IP.text );
